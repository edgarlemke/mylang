...
"""
    ...
    p = Popen(split(f"/usr/bin/python3 ../run.py --expr=\"{expr}\" --print-token-list"), stdout= PIPE, encoding= "utf-8")
    stdout, stderr = p.communicate()
...
"""
    ...
    p = Popen(split(f"/usr/bin/python3 ../run.py --expr=\"{expr}\" --print-parse-tree"), stdout= PIPE, encoding= "utf-8")
    stdout, stderr = p.communicate()
...
"""
    ...
    p = Popen(split(f"/usr/bin/python3 ../run.py --expr=\"{expr}\" --print-raw-ast"), stdout= PIPE, encoding= "utf-8")
    stdout, stderr = p.communicate()
...
"""
    ...
    p = Popen(split(f"/usr/bin/python3 ../run.py --expr=\"{expr}\" --print-symbol-table"), stdout= PIPE, encoding= "utf-8")
    stdout, stderr = p.communicate()
...
"""
    ...
    p = Popen(split(f"/usr/bin/python3 ../run.py --expr=\"{expr}\" --print-final-ast"), stdout= PIPE, encoding= "utf-8")
    stdout, stderr = p.communicate()
