...
def test_rule__expr__quote_qvalue_quote():
    _test(i.getframeinfo(i.currentframe()).function, "\\\" \\\"",
          """((EXPR ((QUOTE 0 1 "\\\"") (QVALUE 1 2 " ") (QUOTE 2 3 "\\\""))))""")
...
def test_rule__expr__float():
    _test(i.getframeinfo(i.currentframe()).function,
          "3.14", """((EXPR ((FLOAT 0 4 3.14))))""")


def test_rule__expr__true():
    _test(i.getframeinfo(i.currentframe()).function,
          "true", """((EXPR ((BOOL 0 4 true))))""")


def test_rule__expr__false():
    _test(i.getframeinfo(i.currentframe()).function,
          "false", """((EXPR ((BOOL 0 5 false))))""")


def test_rule__par_group__par_open_par_close():
    _test(i.getframeinfo(i.currentframe()).function, "()",
          """((EXPR ((PAR_GROUP ((PAR_OPEN 0 1 "(") (PAR_CLOSE 1 2 ")"))))))""")
...
def test_rule__par_group__par_open_expr_par_close():
    _test(
        i.getframeinfo(
            i.currentframe()).function,
        "(\\\"abc\\\")",
        """((EXPR ((PAR_GROUP ((PAR_OPEN 0 1 "(") (EXPR ((QUOTE 1 2 "\\\"") (QVALUE 2 5 abc) (QUOTE 5 6 "\\\""))) (PAR_CLOSE 6 7 ")"))))))""")
